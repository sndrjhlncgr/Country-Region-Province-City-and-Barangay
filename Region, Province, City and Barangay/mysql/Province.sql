...
UPDATE refprovince SET provDesc = CASE WHEN provDesc like "%NCR%" THEN CONCAT(UPPER(SUBSTRING(provDesc,1,3)),LOWER(SUBSTRING(provDesc,4))) ELSE CONCAT(UPPER(SUBSTRING(provDesc,1,1)),LOWER(SUBSTRING(provDesc,2))) END;
